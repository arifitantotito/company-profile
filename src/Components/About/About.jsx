                    ...
                    <div className="flex justify-center items-center pl-32 pb-28">
                        <div className=" max-w-24 mt-56">
                            ...
                            <div className="flex gradient-text-about text-6xl mt-6 tracking-[0.04rem] leading-[70px]">
                                <div>
                                    <span className="text-white">Our</span> Purposes <div><span className="text-white">&</span> <span className="gradient-text-about">Goals</span></div>
                                </div>
                            </div>
